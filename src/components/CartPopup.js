...
export default function CartPopup({ item, onClose }) {
  if (!item) return null;
    ...
    <div className={styles.overlay} onClick={onClose}>
      <div className={styles.popup} onClick={(e) => e.stopPropagation()}>
        ...
        <div className={styles.header}>
          <h2 className={styles.title}>장바구니 담기</h2>
        ...
        <div className={styles.pagination}>
          <span className={styles.pageBtn}>이전 페이지</span>
          <span className={styles.pageNum}>1</span>
          <span className={styles.pageBtn}>다음 페이지</span>
        </div>
